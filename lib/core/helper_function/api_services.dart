...
class ApiServices extends BaseApiServices{
  ...
  Future<Either<Failure, Response>> getData({required String path})async{
    try {
  ...
  Future<Either<Failure, Response>>postData({required String path, Map<String, dynamic>? data})async{
    try {
  ...
  Future<Either<Failure, Response>>patchData({required String path, Map<String, dynamic>? data})async{
    try {
  ...
  Future<Either<Failure, Response>>deleteData({required String path})async{
    try {
